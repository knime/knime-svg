...
/**
 * Dialog for
 * {@link SparkLineNodeModel} - allows to choose numerical columns
 *
 * @author M. Berthold, University of Konstanz
 */
public class SparkLineNodeDialog extends DefaultNodeSettingsPane {

    /**
     * Constructor - Initialize special property panel holding the
     * variables that can be adjusted by the user.
     */
    @SuppressWarnings("unchecked")
    SparkLineNodeDialog() {
        super();
        DialogComponentColumnFilter m_columnFilter =
